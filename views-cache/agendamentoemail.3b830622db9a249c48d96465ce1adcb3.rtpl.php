...
<body bgcolor="#ffffff" style="background-image: url('../../resources/templates/dist/img/comunidade.jpg');">
    ...
    <table class="head-wrap w320 full-width-gmail-android" bgcolor="#f9f8f8" cellpadding="0" cellspacing="0" border="0">
      ...
      <tr class="header-background">
        <td class="header container" align="center">
          <div class="content">
           <center><span class="brand" style="color: #fff; font-size: 15pt;">
                SAPC
            </span></center>
          </div><br><br>
        </td>
            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr><br><br><br>
                      <td class="soapbox-title">SAPC - Agendamento</td>
                    </tr>
                  </table>
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title"><center>Olá <span style="font-size: 16pt;"><?php echo htmlspecialchars( $name, ENT_COMPAT, 'UTF-8', FALSE ); ?>,</span></center></div>
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              <center>Sua visita será no dia: <br><span style="font-size: 13pt;"><?php echo formatDtVisita($data); ?> ás <?php echo htmlspecialchars( $horario, ENT_COMPAT, 'UTF-8', FALSE ); ?></span>hrs.<br>
                                <i><span style="font-size: 13pt;"><?php echo htmlspecialchars( $desendereco, ENT_COMPAT, 'UTF-8', FALSE ); ?></span>.</i>
                              </center>
                            </td>
                          </tr>
                        </table>
      ...
      <tr>
        ...
        <td class="container">
          <div class="content footer-lead">
            <center><span style="color: #fff; font-size: 12pt;">Sistema de Auxílio a Projetos Comunitários - 2019</span></center>
          </div>
        </td>
        <td></td>
      </tr>
