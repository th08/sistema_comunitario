...
<head>
  ...
  <title>SAPC - Redefirnir Senha</title>
  <style type="text/css">
                        ...
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              <center>Acesse o link abaixo para redefinir a sua senha<br> <a href="<?php echo htmlspecialchars( $link, ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $link, ENT_COMPAT, 'UTF-8', FALSE ); ?></a>.</center>
                            </td>
                          </tr>
                        </table>
